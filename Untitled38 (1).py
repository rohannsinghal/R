...
class cbfs(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.panels = []
        self.loaded_file = "/Users/admin/Downloads/MachineLearning-Lecture01.pdf"
...
# Assuming cbfs() and other components are defined appropriately
...
dashboard = pn.Column(
    ...
    pn.Tabs(
        ...
        ('Chat History', tab3),
        ('Configure', tab4),
        tabs_location='above',  # Set tabs_location as needed
    ),
    sizing_mode='stretch_both',  # Adjust sizing mode as needed
)
